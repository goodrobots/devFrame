...
Note -- The clamps are designed with enough surface area to self-align the tubes to an extent, but it helps if you build on a nice flat bench to help ensure the frame is true and square while you tighten fasteners.
{: .notice--primary}
